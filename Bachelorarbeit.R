...
papers_2003 <- data.frame(
  author = c("Augustin, Thomas; Döring, A.; Rummel, D.",
               ...
               "Friedrich, F.; Winkler, Gerhard; Wittich, O.; Liebscher, V.",
               "Gartner, H.; Scheid, S.",
               "Gartner, H.; Scholz, T.",
               "Gehrmann, U.; Hellriegel, B.; Neiss, A.; Fahrmeir, Ludwig",
               "Hahn, Klaus; Prigarin, Sergej; Pütz, Benno",
               "Heim, Susanne; Hahn, Klaus; Auer, Dorothee P.",
               ...
               "Jerak, A.; Wagner, S.",
               "Kehl, V.; Ulm, Kurt",
               "Kehl, V.; Ulm, Kurt; Schmidt, G.; Barthel, Petra; Malik, M.",
               "Klasen, S.; Launov, A.",
               "Klüppelberg, Claudia; Lindner, Alexander M.; Maller, R. A.",
               "Knüsel, L.",
               "Krause, Rüdiger; Tutz, Gerhard",
               "Küchenhoff, Helmut; Bender, R.; Langner, I.; Lenz-Tönjes, R.",
               "Langner, I.; Bender, R.; Lenz-Tönjes, R.; Küchenhoff, Helmut; Blettner, Maria",
               "Launov, A.",
               "Lindner, A.; Meyer, K.",
               "Martin, A.",
               "Martin, A.; Prigarin, Sergej; Winkler, Gerhard",
               "Martin, A.; Prigarin, Sergej; Winkler, Gerhard",
               "Müller, Gernot; Czado, Claudia; Antes, Stefan; Rottenwallner, Martin",
               "Müller, M.; Ulm, Kurt",
               "Prigarin, Sergej; Winkler, Gerhard",
               "Salanti, G.; Ulm, Kurt",
               "Schmid, Volker J.; Held, Leonhard",
               "Schneeweiß, Hans",
               "Schneeweiß, Hans; Cheng, Chi-Lun",
               "Schneeweiß, Hans; Maschke, Erich Otto; Pfannes, Manfred",
               "Smith, Michael; Pütz, Benno; Auer, Dorothee P.; Fahrmeir, Ludwig",
               "Strobl, R.; Salanti, G.; Ulm, Kurt",
               "Tutz, Gerhard",
               "Tutz, Gerhard; Hechenbichler, K.",
               "Tutz, Gerhard; Scholz, T.",
               "Ulm, Kurt; Barthel, Petra; Rolnitzky, Linda; Schneider, Raphael; Malik, M.; Bigger Jr., J. Thomas; Schmidt, Georg",
               "Winkler, Gerhard; Kempe, A.; Liebscher, V.; Wittich, O.",
               "Wolff, J.",
               "Wolff, J.; Trübswetter, P."),
  
  paper = c("Regression calibration for Cox regression under heteroscedastic measurement error - Determining risk factors of cardiovascular diseases from error-prone nutritional replication data",
              ...
              "Multiple Imputation von fehlenden Werten mit Daten über Unterernährung undies Kindersterblichkeit",
  ...
  id = c(345, 338, 309, 336, 313, 332, 321, 331, 357, 353, 320, 317, 361, 305, 334, 329, 322, 315, 354, 358, 356, 355, 333, 306, 326, 310, 323, 311, 366, 352, 337, 367, 312, 346, 362, 351, 347, 360, 349, 327, 335, 363, 318, 359, 304, 365, 314, 339, 340, 307, 316, 364, 319, 303, 348, 344, 343)
)
...
papers_1996 <- data.frame(
  ...
  author = c("Aydemir, Sibel; Aydemir, Ülker; Dirschedl, Peter",
               ...
               "Dannegger, Felix; Klinger, Artur; Ulm, Kurt",
  ...
  id = c(44, 25, 31, 23, 22, 54, 14, 45, 21, 15, 19, 47, 41, 36, 27, 52, 33, 28, 51, 50, 43, 37, 46, 13, 29, 48, 38, 39, 17, 18, 32, 20, 53, 24, 11, 1, 12, 9, 7, 5, 8, 2, 4, 3, 10, 6)
)
...
all_papers <- rbind(papers_1996, papers_1997, papers_1998, papers_1999, papers_2000, papers_2001, papers_2002, papers_2003, papers_2004, papers_2005, papers_2006)
all_papers <- as.data.frame(select(all_papers, year, id, author, -paper))
