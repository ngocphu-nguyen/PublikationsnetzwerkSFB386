...
pdf("C:/Users/Ngoc Phu Nguyen/Documents/GitHub/Bachelorarbeit/Deskriptive Analyse/Coauthor-Network/network2006.pdf", width=20, height=20)
...
pdf("C:/Users/Ngoc Phu Nguyen/Documents/GitHub/Bachelorarbeit/Deskriptive Analyse/Coauthor-Network/network_no_isolated.pdf", width=18, height=18, family = "CMU Serif")
op1 <- par(mar = c(1, 0, 0, 0))
...
pdf("C:/Users/Ngoc Phu Nguyen/Documents/GitHub/Bachelorarbeit/Deskriptive Analyse/Coauthor-Network/networkevolution.pdf", width=16, height=8)
...
for ( i in years ) {
  ...
  set.seed(networkseed)
  coords <- layout_with_fr(graph, niter = 2000)
  file_name <- paste0("C:/Users/Ngoc Phu Nguyen/Documents/GitHub/Bachelorarbeit/Deskriptive Analyse/Coauthor-Network/network", i, ".pdf")
