...
pdf("/Users/pnguyen/Desktop/Bachelorarbeit/network2013-1.pdf", width=20, height=20)
...
pdf("/Users/pnguyen/Desktop/Bachelorarbeit/networkevolution-1.pdf", width=16, height=8)
