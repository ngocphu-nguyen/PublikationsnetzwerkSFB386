...
pdf("./Deskriptive Analyse/Coauthor-Network/biggest-component.pdf", width=16, height=16, family = "CMU Serif")
op1 <- par(mar = c(1, 0, 0, 0))
set.seed(networkseed)
...
pdf("./Deskriptive Analyse/Coauthor-Network/girvan-biggest-component.pdf", width=16, height=16, family = "CMU Serif")
op1 <- par(mar = c(1, 0, 0, 0))
